...
//				
	...
	// trouve le triangle contenant x, y et l'éclate en le supprimant, et recomposant 6 nouveaux triangles
	...
	public void eclateTriangleBis (int x, int y){
		...
		// Si ABC a un sommet A dans un coin, il faut créer les triangles ABx et ACx
